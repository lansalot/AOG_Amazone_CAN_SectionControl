  ...
  const int SPI_CS_PIN = 10;   //ATTENTION !! PIN9 is also used already in Machine USB but is PIN9 or 10 ar needed for CAN Shield. Therefore i replaced the PIN9 in the existing Machine code
  ...
  void setup()
  {
      ...
      while (CAN_OK != CAN.begin(CAN_250KBPS, MCP_8MHz)) {        //init can bus: Amatron baudrate = 250k 
